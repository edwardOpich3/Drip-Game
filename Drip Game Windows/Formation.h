...
public:
	...
	Vector2 position;					// Top-leftmost pixel of the formation
	...
	void load(Vector2 position, Container<ALLEGRO_BITMAP*> obstacleSpr, Container<ALLEGRO_BITMAP*> powerupSpr);		// Loads the formation with objects and places it at (x, y)
