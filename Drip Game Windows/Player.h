...
public:
	...
	Vector2 position;				// Position in the level in pixels. Not screen coordinates.
	Vector2 size;	// Width and height of the player; used for bitmap drawing and collision calculations
	...
	float scale;									// Stored as scale, with 1.0f being 1x size, 2.0f being 2x size, 0.5f being half size, etc.
